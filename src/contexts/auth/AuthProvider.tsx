...
import { AuthUser, profileToAuthUser, userFromMetadata } from '@/utils/authUtils';
...
export type AuthContextType = {
  ...
  createChapter: (chapterData: any) => Promise<string>;
  createClub: (clubData: any) => Promise<string>;
